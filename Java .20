...
public class JPR23 {
    ...
    public static void main(String[] args) {
        ...
        Student s2=new Student("Manisha","FYCSE","A","5/7/2021","Pune","manishababar9604@gmil.com",8767941865);
        ...
        //change email of s2
        s2.changeEmail("manishababar9604@gmail.com");
